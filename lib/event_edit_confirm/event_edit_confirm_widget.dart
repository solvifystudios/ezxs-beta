...
class EventEditConfirmWidget extends StatefulWidget {
  const EventEditConfirmWidget({Key? key}) : super(key: key);

  @override
  _EventEditConfirmWidgetState createState() => _EventEditConfirmWidgetState();
}

class _EventEditConfirmWidgetState extends State<EventEditConfirmWidget> {
